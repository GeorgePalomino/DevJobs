...
@section('content')
<body background="img/123.png" style="background-repeat: no-repeat;background-size: 100% 100%;backdrop-filter: blur(6px);">
            ...
            <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('login') }}"novalidate>
                        ...
                        <div class="flex flex-wrap">
                                <button
                                    type="submit"
                                    class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100
