    ...
    <div class="flex flex-wrap justify-center">
        <div class="md:w-1/2 order-2 md:order-1">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white  border border- shadow-md mt-20">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}"novalidate>
                            ...
                            <div class="flex flex-wrap">
                                    ...
                                    p-3 focus:outline-none focus:shadow-outline uppercase fond-bold">
                                        {{ __('Register') }}
                                    </button>
                            </div>
                        </form>
        ...
        <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
            <h1 class="text-teal-500 text-3xl">¿Eres una Empresa?</h1>
            <p1 class="text-xl mt-5 leading-7">Crea una cuenta totalmente gratis y comienza a publicar hasta 10 vacantes</p>
        </div>
    </div>
</div>
@endsection
